...
import RolePermissionMenu from '../Header/RolePermissionMenu'
...
const Navigation = ({ user, isSystemAdmin }: NavigationPropsType) => {
                ...
                <div className="flex justify-between h-16">
                    <div className="flex">
                        ...
                        <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <NavLink
                                href="/dashboard/appServiceManager"
                                active={false}>
                            ...
                            {isSystemAdmin && (
                                <>
                                    <NavLink href="/role" active={false}>
                                        <RolePermissionMenu />
                                    </NavLink>
                                    <NavLink
                                        href="/user"
                                        ...
                                        <Typography
                                            variant="h6"
                                            className="inline-flex items-center gap-x-1 text-sm font-bold">
                                            User
                                        </Typography>
                                    </NavLink>
                                </>
